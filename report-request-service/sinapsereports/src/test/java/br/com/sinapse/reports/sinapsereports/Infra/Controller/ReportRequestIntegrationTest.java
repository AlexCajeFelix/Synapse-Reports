 ...
 * import br.com.sinapse.reports.sinapsereports.Application.Dtos.
 ...
 * 
 * import static
 * br.com.sinapse.reports.sinapsereports.Factory.CreateRequestDtoFactory.
 * createValidCreateReportRequestDto;
 * 
 ...
 * HttpEntity<CreateReportRequestDto> requestEntity = new
 * HttpEntity<>(requestDto, headers);
 * 
 * ResponseEntity<ReportRequestResponseDto> response =
 ...
 * @Test
 * public void
 * given_valid_report_when_create_report_request_then_status_should_eventually_be_pending_send
 * () {
 * 
 * var requestDto = createValidCreateReportRequestDto();
 * HttpHeaders headers = new HttpHeaders();
